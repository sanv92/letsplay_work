(function ($) {
	...
	$.widget("ui.rcarousel", {
		_create: function() {
			...
			// save all children of root element in вЂpathsвЂ™ array
			this._saveElements();
		...
		_generatePages: function() {
			...
			// creates 3 pages for вЂvisible: 5вЂ™ and вЂstep: 4вЂ™:
			// [ABCDE], [EFGHI], [FGHIJ]
			...
			function _paginate() {
				...
				while ( !_islastPage(data.pages[data.pages.length - 1]) || _isBeginning ) {
					...
					// when we run ouf of elements (_end - _start <В _visible) we must add the difference at the begining
					// in our example the 3rd page is [FGHIJ] and J element is added in the second step
					// first we add [FGHI] as old elements
					// we must assure that we have always вЂvisibleвЂ™ (5 in our example) elements
					...
					if ( _complement ) {
						...
						// first add old elemets; for 3rd page it adds [FGHIвЂ¦]
		...
		_goToPrevPage: function( by ) {
			...
			// CD page was shown (from 5 elements) вЂ_theSameвЂ™ is true because
			// we compare the same
			...
			// for [ABCDFGHIJ] elements there are 3 pages for вЂvisibleвЂ™ = 6 and
			// вЂstepвЂ™ = 2: [ABCDEF], [CDEFGH] and [EFGHIJ]; going from the 3rd
		...
		_goToNextPage: function( by ) {
			...
			// ABCD page was shown (from 5 elements) вЂ_theSameвЂ™ is true because
			// we compare the same
			...
			// for [ABCDFGHIJ] elements there are 3 pages for вЂvisibleвЂ™ = 6 and
			// вЂstepвЂ™ = 2: [ABCDEF], [CDEFGH] and [EFGHIJ]; going from the 2nd
		...
		_saveElements: function() {
			...
			$elements.each(
				function( i, el ) {
					...
					// keep elementвЂ™s data and events
